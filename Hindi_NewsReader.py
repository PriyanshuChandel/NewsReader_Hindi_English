...
def newspaper_reader(str):
    ...
    playsound(r"C:\Users\User\PycharmProjects\PythonTuts\hindinews.mp3")
    os.remove("hindinews.mp3")


if __name__ == '__main__':
    newspaper_reader("Starting to read India's top headline for today")
    url = "https://newsapi.in/newsapi/news.php?key=i4RDZ0raNrW5eOOvaFBYpokB1N39NL&category=hindi_state"
    num = 1
